(function() {
  ...
  window.icyModules.curlview = {
    ...
    html: `
      ...
      <div id="curl-out" style="white-space:pre-wrap;font-family:monospace;font-size:13px;color:#e0e6ed;min-height:60px;background:#0f1115;border:1px solid #2b3039;padding:10px;border-radius:6px;overflow:auto;max-height:260px">Enter a URL and press Fetch. Requires STA internet.</div>
    `,
