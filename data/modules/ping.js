(function() {
  ...
  window.icyModules.ping = {
    ...
    html: `
      ...
      <div id="ping-out" style="white-space:pre-wrap;font-family:monospace;font-size:13px;color:#e0e6ed;min-height:60px;background:#0f1115;border:1px solid #2b3039;padding:10px;border-radius:6px;overflow:auto;-webkit-overflow-scrolling:touch;max-height:260px">Enter a host and press Ping. Requires STA internet.</div>
    `,
